...
# Databricks with PySpark (databricks)

Azure Databricks development environment with PySpark, Databricks CLI, Asset Bundles, and pre-commit tools
...
| installSparkLocally | Install Apache Spark locally for offline development | boolean | false |
...
_Note: This file was auto-generated from the [devcontainer-template.json](https://github.com/Arclytics/arc-devcontainers/blob/main/src/databricks/devcontainer-template.json).  Add additional notes to a `NOTES.md`._
