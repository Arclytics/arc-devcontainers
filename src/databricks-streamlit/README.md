...
# Databricks with Streamlit (databricks-streamlit)

Azure Databricks development environment for Streamlit apps with Databricks CLI, Streamlit, and pre-commit tools
...
| databricksCLIVersion | Version of Databricks CLI to install | string | 0.250.0 |
| streamlitVersion | Version of Streamlit to install | string | 1.32.0 |
...
_Note: This file was auto-generated from the [devcontainer-template.json](https://github.com/Arclytics/arc-devcontainers/blob/main/src/databricks-streamlit/devcontainer-template.json).  Add additional notes to a `NOTES.md`._
